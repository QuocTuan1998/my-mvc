...
<div class="d-flex justify-content-center align-items-center h-100">
    <div style="max-width:400px">
        ...
        <!-- form login -->    
        <form id="login" action="/mvc/Login/submitLogin" method="post">  
            ...
            <div class="d-flex justify-content-center mt-5" >                
                <input  id="btnLogin" name="btnLogin" type="submit" value="Login" class="btn btn-outline-dark" style="max-width:150px; width:150px; font-size:1.3rem" onClick="login()">
            </div>
        </form>
